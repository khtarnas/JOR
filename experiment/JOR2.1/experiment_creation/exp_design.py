...
for i in range(1, study_length):
    ...
    counter+= 2 #changing this to be 1 means only every other studied item (in this studied block) will not be tested, but this will mean less context interferences
