...
def word_usable(card_nums, index):
    #print(card_nums)
    #print(index == 0)
    ...
    for _ in range(2):
        if (delay == 0):
            ...
            while True:
                ...
                test = card_nums[pos]
                #print('test = ' + str(test))
                #print('delay before = ' + str(delay))

                if word_usable(card_nums, test):
                    break
...
#print()
#print([x for x in test_order if x not in study_order])
#print()
#print([x for x in study_order if x not in test_order])
#print()
#print(testable)
print(card_nums)
print(counter)
...
for i in range(5): #5 different test periods
    ...
    # Create temporary variable for a reset
    count_tracker = 0
    temp_study_order = []
